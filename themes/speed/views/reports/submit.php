		...
		<div class="big-block">
			...
			<div class="report_left">
				<div class="report_row">
					...
					<?php print form::input('incident_title', $form['incident_title'], ' class="text long input-block-level"'); ?>
				</div>
				<div class="report_row">
					<h4><?php echo Kohana::lang('ui_main.reports_description'); ?> <span class="required">*</span> </h4>
					<?php print form::textarea('incident_description', $form['incident_description'], ' rows="10" class="textarea long input-block-level" data-toggle="tooltip" title="'.html::escape(html::allowed_html()).'"') ?>
				</div>
				<div class="report_row" id="datetime_default">
					<h4>
						<a href="#" id="date_toggle" class="show-more"><?php echo Kohana::lang('ui_main.modify'); ?></a>
				...
				<div class="report_row hide" id="datetime_edit">
					...
					<div class="time">
						...
						<?php
							...
							print form::dropdown('incident_hour',$hour_array,$form['incident_hour'], " class='input-mini'");
							print '<span class="dots">:</span>';
							print form::dropdown('incident_minute',$minute_array,$form['incident_minute'], " class='input-mini'");
							print '<span class="dots">:</span>';
							print form::dropdown('incident_ampm',$ampm_array,$form['incident_ampm'], " class='input-mini'");
						?>
				...
				<div class="report_row">
					...
					<?php
						...
						echo category::form_tree('incident_category', $selected_categories, 1);
						?>
					</div>
				</div>
			...
			<div class="report_right">
				...
				<div class="report_row">
					...
					<div class="report-find-location">
						...
						<div class="btns">
							<ul>
								<li><a href="#" class="btn btn-danger btn_del_last"><?php echo utf8::strtoupper(Kohana::lang('ui_main.delete_last'));?></a></li>
								<li><a href="#" class="btn btn-danger btn_del_sel"><?php echo utf8::strtoupper(Kohana::lang('ui_main.delete_selected'));?></a></li>
								<li><a href="#" class="btn btn-danger btn_clear"><?php echo utf8::strtoupper(Kohana::lang('ui_main.clear_map'));?></a></li>
							</ul>
						</div>
						<div style="clear:both;"></div>
						<?php print form::input('location_find', '', ' title="'.Kohana::lang('ui_main.location_example').'" class="findtext"'); ?>
						<input type="button" name="button" id="button" value="<?php echo Kohana::lang('ui_main.find_location'); ?>" class="btn  btn_find" />
				...
				<div class="report_row">
					...
					<?php print form::input('location_name', $form['location_name'], ' class="text long input-xxlarge"'); ?>
				</div>
				...
				<div id="divNews" class="report_row">
					...
					<?php if (empty($form['incident_news'])): ?>
						<div class="report_row">
							<?php print form::input('incident_news[]', '', ' class="text long2 input-xxlarge"'); ?>
					...
					<?php else: ?>
						...
						<div class="report_row" id="<?php echo $i; ?>">
							<?php echo form::input('incident_news[]', $value, ' class="text long2 input-xxlarge"'); ?>
							<a href="#" class="add" onClick="addFormField('divNews','incident_news','news_id','text'); return false;">add</a>
				...
				<div id="divVideo" class="report_row">
					...
					<?php if (empty($form['incident_video'])): ?>
						<div class="report_row">
							<?php print form::input('incident_video[]', '', ' class="text long2 input-xxlarge"'); ?>
					...
					<?php else: ?>
						<?php foreach ($form['incident_video'] as $value): ?>
							...
							<?php print form::input('incident_video[]', $value, ' class="text long2 input-xxlarge"'); ?>
							<a href="#" class="add" onClick="addFormField('divVideo','incident_video','video_id','text'); return false;">add</a>
				...
				<div id="divPhoto" class="report_row">
					...
					<div class="report_row">
						<?php print form::upload('incident_photo[]', '', ' class="file long2 input-xxlarge"'); ?>
					...
					<?php else: ?>
						<?php foreach ($form['incident_photo']['name'] as $value): ?>
							...
							<div class="report_row" id="<?php echo $i; ?>">
								<?php print form::upload('incident_photo[]', $value, ' class="file long2 input-xxlarge"'); ?>
								<a href="#" class="add" onClick="addFormField('divPhoto','incident_photo','photo_id','file'); return false;">add</a>
				...
				<div class="report_optional">
					...
					<div class="report_row">
						...
						<?php print form::input('person_first', $form['person_first'], ' class="text long input-xlarge"'); ?>
					</div>
					<div class="report_row">
						<h4><?php echo Kohana::lang('ui_main.reports_last'); ?></h4>
						<?php print form::input('person_last', $form['person_last'], ' class="text long input-xlarge"'); ?>
					</div>
					<div class="report_row">
						<h4><?php echo Kohana::lang('ui_main.reports_email'); ?></h4>
						<?php print form::input('person_email', $form['person_email'], ' class="text long input-xlarge"'); ?>
					</div>
					<?php
				...
				<div class="report_row">
					<input name="submit" type="submit" value="<?php echo Kohana::lang('ui_main.submit'); ?>" class="btn btn-success btn_submit" />
				</div>
			</div>
		</div>
