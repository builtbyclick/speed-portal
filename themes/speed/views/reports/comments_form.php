...
<div class="comment-block">
	...
	<h5 class="leave-comment"><?php echo Kohana::lang('ui_main.leave_a_comment');?></h5>
	<?php
	if ($form_error)
	{
		?>
	...
	?>
	<div class="report_row">
		<input name="submit" type="submit" value="<?php echo Kohana::lang('ui_main.reports_btn_submit'); ?> <?php echo Kohana::lang('ui_main.comment'); ?>" class="btn  btn-success  btn_blue" />
	</div>
