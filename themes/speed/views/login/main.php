...
echo html::stylesheet(url::file_loc('css').'themes/speed/css/speed', '', TRUE);
...
<div id="header">
	...
	<!-- logo -->
	<?php if ($banner == NULL): ?>
	<div id="logo" class="ushahidi_site_name">
...
<div class="disclaimer">
	<?php Kohana::lang('ui_main.login_disclaimer'); ?>
</div>
...
<div id="password_reset_change_form" class="ui-corner-all">
	...
	<?php echo form::open(NULL, array('id' => "changepass_form")); ?>
		...
		<table width="100%" border="0" id="ushahidi_loginbox">
			<?php
				$hidden = 'hidden';
			...
			<tr>
				<td><input type="submit" id="submit" name="submit" value="<?php echo Kohana::lang('ui_main.change_password'); ?>" class="btn-success login_btn" /></td>
			</tr>
		</table>
...
<div id="openid_login" class="login-container  ui-corner-all">
		...
		<div id="resend_confirm_email" class="signin_select ui-corner-all">
			<?php echo form::open(NULL, array('id'=>"resendconfirm_form")); ?>
				...
				<table width="100%" border="0" id="ushahidi_loginbox">
					...
					<tr>
						<td><input type="submit" id="submit" name="submit" value="<?php echo Kohana::lang('ui_main.send_confirmation'); ?>" class="btn  btn-success  login_btn" /></td>
					</tr>
				</table>
			<?php echo form::close(); ?>
		</div>
	...
	<div id="signin_userpass" class="signin_select ui-corner-all">
		...
		<?php echo form::open(NULL, array('class'=>"userpass_form")); ?>
			...
			<table width="100%" border="0" id="ushahidi_loginbox">
				...
				<tr>
					<td><input type="submit" id="submit" name="submit" value="<?php echo Kohana::lang('ui_main.login'); ?>" class="btn  btn-success  login_btn" /></td>
				</tr>
	...
	<div id="signin_forgot" class="signin_select ui-corner-all">
		<?php echo form::open(NULL, array('id'=>"userforgot_form")); ?>
			...
			<table width="100%" border="0" id="ushahidi_loginbox">
				...
				<tr>
					<td><input type="submit" id="submit" name="submit" value="<?php echo Kohana::lang('ui_main.reset_password'); ?>" class="btn  btn-danger  login_btn" /></td>
				</tr>
			</table>
		<?php echo form::close() ?>
	</div>
...
<div id="create_account" class="login-container  ui-corner-all">

	<h2><a href="javascript:toggle('signin_new');"><?php echo Kohana::lang('ui_main.login_signup_click'); ?></a></h2>

	<small><?php echo Kohana::lang('speed.login_signup_text'); ?></small>
	...
	<div id="signin_new" class="signin_select ui-corner-all">
		...
		<?php echo form::open(NULL,  array('id' => "usernew_form")); ?>
			...
			<table width="100%" border="0" cellspacing="3" cellpadding="4" background="" id="ushahidi_loginbox">
				...
				?>
				<tr>
					<td><input type="submit" id="submit" name="submit" value="<?php echo Kohana::lang('ui_main.login_signup');?>" class="btn  btn-success  login_btn new_submit" /></td>
				</tr>
			</table>
		<?php echo form::close(); ?>
	</div>
