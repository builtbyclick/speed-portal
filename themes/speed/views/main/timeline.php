<div class="slider-holder">
	<?php echo form::open(NULL, array('method' => 'get')); ?>
		...
		<fieldset>
			...
			<select name="startDate" id="startDate" class="input-medium"><?php echo $startDate; ?></select>
			<label for="endDate"><?php echo Kohana::lang('ui_main.to'); ?>:</label>
			<select name="endDate" id="endDate" class="input-medium"><?php echo $endDate; ?></select>
		</fieldset>
	<?php echo form::close(); ?>
</div>
