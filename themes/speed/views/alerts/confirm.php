			...
			<div class="green-box">
				...
				<div class="alert_response">
					...
					<div class="alert_confirm">
						...
						print form::submit('button', 'Confirm My Alert Request', ' class="btn btn_submit"');
						print form::close();
						?>
					</div>
				</div>
			...
			<div class="green-box">
				...
				<div class="alert_response">
					...
					<div class="alert_confirm">
						...
						print form::submit('button', 'Confirm My Alert Request', ' class="btn  btn-success  btn_submit"');
						print form::close();
						?>
					</div>
				</div>
