	...
	<div class="content-bg">
		...
		<div class="big-block">
			...
			<div class="step-2-holder">
						...
						<div class="box">
							<label>
								...
								<span>
									...
									<small><?php echo Kohana::lang('ui_main.alerts_enter_mobile'); ?></small>
								</span>
							</label>
						...
						<div class="box">
							<label>
								...
								<span>
									...
									<small><?php echo Kohana::lang('ui_main.alerts_enter_email'); ?></small>
								</span>
							</label>
				...
				<input id="btn-send-alerts" class="btn btn-success btn_submit" type="submit" value="<?php echo Kohana::lang('ui_main.alerts_btn_send'); ?>" />
				<BR /><BR />
