...
class Themes_Core {
	...
	*/
	...
	public function requirements()
	{
		...
		Requirements::js("media/js/jquery.pngFix.min.js");
		Requirements::js("media/js/jquery.timeago.min.js");
		...
		{
			Requirements::js('media/js/selectToUISlider.jQuery.min.js');
		}
		...
		if ($this->treeview_enabled)
		{
			...
			Requirements::js("media/js/jquery.treeview.min.js");
		}
		...
		if ($this->colorpicker_enabled)
		{
			...
			Requirements::js("media/js/colorpicker.min.js");
		}
		...
		$base_js = array(
			...
			'media/js/jquery.pngFix.min.js',
			'media/js/jquery.timeago.min.js',
			'media/js/global.js',
			//'media/js/OpenLayers.js',
			//'media/js/ushahidi.js',
			'media/js/jquery.treeview.min.js',
			'media/js/selectToUISlider.jQuery.min.js',
			'media/js/jquery.validate.min.js',
			'media/js/colorpicker.min.js',
		);
		if ($this->timeline_enabled)
		{
...
SCHEDULER;
	...
	*/
	...
	private static function load_theme_js($theme)
	{
		...
		foreach (self::$theme_js as $js => $path)
		{
			if (file_exists(THEMEPATH."$theme/js/$js.js"))
				self::$theme_js[$js] = "themes/$theme/js/$js.js";
		}
