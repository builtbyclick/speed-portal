...
//	$text = preg_replace_callback($this->search, array($this, '_preg_callback'), $text);

//	$pregIteration = 0;
//	foreach($this->search as $srch) {
//		$replace=$this->replace[$pregIteration];
//		$replace=str_replace(array('\\1','\\2'),array('$a','$b'),$replace);
//		if($replace=="") $replace='""';
//		try{
//		if(strpos($replace,'$b')>0) {
//		$text=preg_replace_callback($srch,create_function('$a,$b','return '.$replace),$text);
//		} else {
//	                $text=preg_replace_callback($srch,create_function('$a','return '.$replace),$text);
//		}
//		} catch(Exception $e) {
//		die('srch '.$srch." ----- ".$replace);
//		}
//		$pregIteration++;
//	}
