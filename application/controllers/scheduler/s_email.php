	...
	*/
	private function add_email($messages)
	{
		...
		foreach($messages as $message) {
			...
			// DB Expression used to do case insensitive comparison on email
			$expr = new Database_Expression('LCASE(`service_account`) = :name', array(':name' => utf8::strtolower($message['email'])));
