		<div class="bg">
				<h2>
					<?php admin::reporters_subtabs(); ?>
				</h2>
				<!-- tabs -->
				<div class="tabs">
					<!-- tabset -->
					<ul class="tabset">
						  <?php admin::reporters_subsubtabs($service_id); ?>
					</ul>
					<!-- tab -->
					<div class="tab">
						<ul>
				...
				<div class="tabs">
					...
					<div class="tab">
						...
						<div class="tab_form_item">
							<?php print form::dropdown('s', $search_service_array, $search_type); ?>
						</div>				
						<div class="tab_form_item">
							<?php print form::dropdown('l', $search_level_array, $search_level); ?>
						</div>				
						<div class="tab_form_item">
							...
							<table class="table">
								<thead>
									<tr>
										...
										<th class="col-3"><?php echo Kohana::lang('ui_main.service_username');?></th>
								...
								<tbody>
									...
									foreach ($reporters as $reporter)
									{
										...
										$reporter_name = $reporter->reporter_first . " " . $reporter->reporter_last;
										
										$reporter_category = "";
										foreach($reporter->reporter_category as $category)
										{
											//$reporter_category .= Category_Lang_Model::category_title($category->category_id) ."&nbsp;&nbsp;";
											$reporter_category .= "<a href=\"#\">" . $category->category->category_title . "</a>&nbsp;&nbsp;";
										}
							    	...
							    	// Get Location Information
										...
										<tr>
											...
											<td class="col-2">
												<div class="post">
													<h4><?php echo $reporter_name; ?> <span>[<a href="<?php echo url::site()."admin/messages/index/".$service_id."?rid=".$reporter_id;?>">View Messages</a>]</span></h4>
												</div>
												<ul class="info">
											...
											<ul class="links">
												<li class="none-separator"><?php echo Kohana::lang('ui_main.categories');?>:<?php echo $reporter_category; ?></li>
											</ul>
											</td>
											<td class="col-3">
												<div>
													<?php echo $service_account; ?>
												</div>
											</td>
											<td class="col-3">
												<div>
											...
											<td class="col-4">
												<ul>
													<li class="none-separator"><a href="<?php echo url::site()."admin/reporters/edit/".$reporter_id;?>"><?php echo Kohana::lang('ui_main.edit');?></a></li>
