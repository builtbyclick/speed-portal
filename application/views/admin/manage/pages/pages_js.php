...
{
	$("#page_id").attr("value", fields.page_id);
	$("#page_title").attr("value", fields.page_title);
	$("#page_tab").attr("value", fields.page_tab);
	$("#page_description").attr("value", fields.page_description);
	$("#page_description").wysiwyg("setContent", fields.page_description);
}
